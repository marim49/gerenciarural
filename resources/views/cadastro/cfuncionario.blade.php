					...
					<div class="panel-body">
						...
						<div class="row">
							<div class="col-md-4">
								<div class="form-group">
									<label>Nome:</label>
									<input class="form-control" name="nome" required maxlength="100" type="text" placeholder="Insira aqui o nome completo do funcionário"
									    maxlength="100" value="{{ old('nome')}}" />
								</div>
								<div class="form-group">
									<label>RG:</label>
									<input class="form-control" name="rg" type="text" required maxlength="45" placeholder="Insira aqui o RG do funcionário" maxlength="45"
									    value="{{ old('rg')}}" />
								</div>
								<div class="form-group">
									<label>Estado Civil:</label>
									<div class="form-group">
										<select class="form-control" required name="id_estado_civil">
								...
								<div class="form-group">
									<label>Rua:</label>
									<input class="form-control" type="text" name="endereco_rua" required maxlength="45" placeholder="Insira aqui o endereço do funcionário"
									    maxlength="45" value="{{ old('endereco_rua')}}" />
								</div>
								<div class="form-group">
									<label>Bairro:</label>
									<input class="form-control" type="text" name="endereco_bairro" required maxlength="45" placeholder="Insira aqui o bairro do funcionário"
									    maxlength="45" value="{{ old('endereco_bairro')}}" />
								</div>
								<div class="form-group">
									<label>País:</label>
									<input class="form-control" name="endereco_pais" type="text" required maxlength="45" placeholder="Insira aqui o país do funcionário"
									    maxlength="45" value="{{ old('endereco_pais')}}" />
								</div>
							</div>
							...
							<div class="col-md-4">
								...
								<div class="form-group">
									<label>Cidade:</label>
									<input class="form-control" name="endereco_cidade" type="text" required placeholder="Insira aqui a cidade do funcionário"
									    maxlength="45" value="{{ old('endereco_cidade')}}" />
								</div>
								<div class="form-group">
									<label>Cargo:</label>
									<input class="form-control" type="text" name="cargo" required placeholder="Insira aqui a função do funcionário" maxlength="45"
									    value="{{ old('cargo')}}" />
								</div>
							</div>
							...
							<div class="col-md-4">
								<div class="form-group">
									<label>PIS:</label>
									<input class="form-control" name="pis" required type="text" placeholder="PIS do funcionário" maxlength="45" value="{{ old('pis')}}" />
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label>Estado:</label>
									<input class="form-control" name="endereco_estado" required type="text" placeholder="Insira aqui o estado" maxlength="45"
